...
public class BottomTabLayout extends LinearLayout {
    ...
    private BottomTabLayout.OnTabSelectedListener mListener;
    ...
    public BottomTabLayout addItem(final BottomTabView tab) {
    ...
    public void setOnTabSelectedListener(BottomTabLayout.OnTabSelectedListener onTabSelectedListener) {
     ...
     * 获取 Tab
     */
    public BottomTabView getItem(int index) {
    ...
    protected Parcelable onSaveInstanceState() {
        ...
        return new BottomTabLayout.SavedState(superState, mCurrentPosition);
    }
    ...
    static class SavedState extends View.BaseSavedState {
        ...
        public static final Creator<SavedState> CREATOR = new Creator<SavedState>() {
            public BottomTabLayout.SavedState createFromParcel(Parcel in) {
                return new BottomTabLayout.SavedState(in);
            }

            public BottomTabLayout.SavedState[] newArray(int size) {
                return new BottomTabLayout.SavedState[size];
            }
        };
    }
