...
public class ListShowPresenter extends BasePresenter<IListShowView> {

    public void queryList(final Map<String, Object> parameters) {
        ...
        RetrofitHelper.getInstance().request(new BaseSubscriber<String>() {
            ...
            return apiService.getList(RequestBody.create(RequestHandler.MEDIA_TYPE, requestParams));
        });
    }
}
